  ...
  const resumeTemplates = [
    ...
    { name: 'Modern', image: '/images/celibi.png' },
    { name: 'Classic', image: '/images/leafish.png' },
    { name: 'Creative', image: '/images/modern.png' },
  ];
    ...
    <select
      className="w-full p-2 border border-gray-300 rounded-md bg-black text-white hover:border-white focus:border-white focus:outline-none transition-colors duration-200"
      value={fontStyle === 'italic' ? 'italic' : fontWeight === 700 ? 'bold' : 'regular'}
      onChange={(e) => {
